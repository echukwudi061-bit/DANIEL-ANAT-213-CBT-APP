    ...
    return (
      <div className="h-[100dvh] bg-gray-50 flex flex-col font-sans overflow-hidden">
        ...
        <div className="flex flex-1 overflow-hidden relative">
            ...
            <aside className={`
                /* --- CONTAINER --- */
                /* FIXED: We use 'h-[100dvh]' instead of 'inset-y-0' */
                /* This forces the sidebar to fit the EXACT visible mobile screen height */
            ...
            `}>
                ...
                {/* flex-shrink-0: Ensures this NEVER gets pushed off screen */ }
